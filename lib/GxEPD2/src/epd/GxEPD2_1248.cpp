...
void GxEPD2_1248::init(uint32_t serial_diag_bitrate, bool initial, uint16_t reset_duration, bool pulldown_rst_mode)
{
  ...
  pinMode(_busy_m1,  INPUT_PULLDOWN);
  pinMode(_busy_s1,  INPUT_PULLDOWN);
  pinMode(_busy_m2,  INPUT_PULLDOWN);
  pinMode(_busy_s2,  INPUT_PULLDOWN);
